...
public class RecyclerMineWorkViewItemAdapter extends RecyclerView.Adapter {
    ...
    public RecyclerMineWorkViewItemAdapter(List<HomeItemModel> list, Context context) {
        this.list = list;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        RecyclerView.ViewHolder  holder = new MyFrag0ViewHolder(LayoutInflater.from(context).inflate(R.layout.item_mine_work_img, parent, false));
        return holder;
    }
...
// 在这里对获取对象进行操作
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        if(holder instanceof MyFrag0ViewHolder){
            ...
            frag0ViewHolder.editButton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    if(onButtonClickListener != null){
                        onButtonClickListener.onButtonEditClick(position);
                    }
                }
            });
            frag0ViewHolder.deleteButton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    if(onButtonClickListener != null){
                        onButtonClickListener.onButtonDeleteClick(position);
                    }
                }
            });
    ...
    public class MyFrag0ViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyFrag0ViewHolder(View itemView) {
            ...
            editButton = itemView.findViewById(R.id.buttono_edit);
            deleteButton = itemView.findViewById(R.id.buttono_delete);
        }
    }
