...
public class Frag_main1 extends BaseFragment{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.frag_main1, container, false);
    }
    ...
    protected void initView(View view){
        ...
        refreshView.setOnRefreshListener(new Frag_main1.OnRefresh());
        refreshView.setOnLoadmoreListener(new Frag_main1.OnLoadMore());
