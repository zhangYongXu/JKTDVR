...
public class Tool {
    ...
    public static boolean isNull(String str) {
        if (str == null || str.trim().length() == 0 || "null".equals(str) || str.equals("")) {
            return true;
        }
        return false;
    }
    ...
    public static String getParams(Context context, HashMap<String, Object> hashMap) {
        JSONObject param = new JSONObject(hashMap);
...
//        }
        ...
        Log.i("httpParamsJsonString:",param.toString());
    ...
    */
    ...
    //从Assets文件夹中读一个json格式的文本文件
    @NonNull
    public static String getJsonFromLocalAssets(Context mContext, String fileName) {
